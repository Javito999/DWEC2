...
document.getElementById('parrafo').addEventListener('click', insertarEncabezadoH2, false);
 ...
 */
document.getElementById('cambiaH2').addEventListener('dblclick', cambiarEstilos, false);
function cambiarEstilos() {
    let parrafos = document.getElementsByTagName("p");
    let elementosLi = document.getElementsByClassName("par");
    let encabezado = document.getElementsByClassName("destacado");
